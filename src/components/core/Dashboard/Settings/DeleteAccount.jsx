...
export default function DeleteAccount() {
  ...
  return (
    <>
      <div className="rounded-lg border border-pink-700 bg-pink-900 p-6 md:p-8">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="space-y-3">
            ...
            <div className="text-pink-25 space-y-2">
            ...
            <button
              type="button"
              className="w-fit italic text-pink-300 hover:text-pink-200 transition-colors"
