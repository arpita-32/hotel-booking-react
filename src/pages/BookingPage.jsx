    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          >
            Experience luxury redefined at <span className="font-semibold text-yellow-600">Luxury Haven</span>
          </motion.p>
        </div>
          ...
          {[1, 2, 3].map((stepNumber) => (
            <div key={stepNumber} className="flex flex-col items-center relative z-10">
              <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-colors duration-300 
                ${step >= stepNumber ? 'bg-yellow-600 text-white shadow-md' : 'bg-gray-200 text-gray-600'}`}>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full px-4 py-3 border ${errors.checkIn ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition`}
                        required
                      />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full px-4 py-3 border ${errors.checkOut ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition`}
                        required
                      />
                    ...
                    {roomTypes.map(room => (
                      ...
                      >
                        ...
                        <label htmlFor={room.id} className="block cursor-pointer">
                          ...
                          <div className="text-yellow-600 font-semibold mb-2">${room.price}/night</div>
              ...
              >
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 mb-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border-t border-gray-200 mt-3 pt-3 flex justify-between">
                      ...
                      <span className="text-lg font-bold text-yellow-600">${totalPrice}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center bg-yellow-600 hover:bg-yellow-700 text-white px-8 py-3 rounded-lg font-medium transition duration-300 shadow-md hover:shadow-lg ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
                  >
                    {isSubmitting ? (
                      <>
