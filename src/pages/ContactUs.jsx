...
const ContactUs = () => {
  return (
    <div className="bg-black text-yellow-50 min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="bg-gray-900 w-full py-12 md:py-16 lg:py-20 pt-22">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8 text-center">
          ...
          <motion.p 
            ...
            className="text-gray-400 mx-auto max-w-2xl text-base sm:text-lg md:text-xl"
          >
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="w-full lg:w-1/2">
              <motion.div 
                ...
                transition={{ duration: 0.5 }}
                viewport={{ once: true }}
                className="bg-gray-800 rounded-xl p-6 sm:p-8 md:p-10 h-full"
              >
                <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-yellow-500">Contact Information</h2>
                
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    <FiMapPin className="text-yellow-500 mt-1 text-xl flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-lg mb-1">Address</h3>
                      <p className="text-gray-400">123 Luxury Avenue, Beachfront District<br />Coastal City 90210</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-4">
                    <FiPhone className="text-yellow-500 text-xl flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-lg mb-1">Phone</h3>
                      <a href="tel:+15551234567" className="text-gray-400 hover:text-yellow-500 transition">+1 (555) 123-4567</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    <FiClock className="text-yellow-500 mt-1 text-xl flex-shrink-0" />
                    <div>
            ...
            {/* Contact Form */}
            <div className="bg-gray-800 w-full lg:w-1/2">
              <motion.div
                initial={{ opacity: 0, x: 20 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5 }}
      ...
      {/* Testimonials */}
      <section className="bg-gray-900 w-full py-12 md:py-16 lg:py-20">
