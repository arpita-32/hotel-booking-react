...
<Navbar/>
      ...
      <section id="contact" className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-3 md:mb-4">Contact Us</h2>
            <p className="text-gray-600 text-sm md:text-base max-w-2xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 md:gap-10">
            <div className="lg:w-1/2">
              <form className="space-y-4 md:space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
                    <label htmlFor="name" className="block text-gray-700 font-medium mb-1 md:mb-2 text-sm md:text-base">Name</label>
                    <input 
                      type="text" 
                      id="name" 
                      className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-600 text-sm md:text-base"
                      placeholder="Your Name"
                    />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-gray-700 font-medium mb-1 md:mb-2 text-sm md:text-base">Email</label>
                    <input 
                      type="email" 
                      id="email" 
                      className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-600 text-sm md:text-base"
                ...
                <div>
                  <label htmlFor="subject" className="block text-gray-700 font-medium mb-1 md:mb-2 text-sm md:text-base">Subject</label>
                  <input 
                    type="text" 
                    id="subject" 
                    className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-600 text-sm md:text-base"
                ...
                <div>
                  <label htmlFor="message" className="block text-gray-700 font-medium mb-1 md:mb-2 text-sm md:text-base">Message</label>
                  <textarea 
                    id="message" 
                    rows="4" 
                    className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-600 text-sm md:text-base"
                ...
                <button 
                  type="submit" 
                  className="bg-yellow-600 hover:bg-yellow-700 text-white px-6 py-2 md:px-8 md:py-3 rounded-md font-medium transition duration-300 text-sm md:text-base"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="lg:w-1/2">
              <div className="bg-gray-100 p-6 md:p-8 rounded-lg h-full">
                <h3 className="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6">Get in Touch</h3>
                
                <div className="space-y-4 md:space-y-6">
                  <div className="flex items-start">
                    <FiMapPin className="text-yellow-600 text-lg md:text-xl mt-1 mr-3 md:mr-4" />
                    <div>
                      <h4 className="font-medium text-gray-800 mb-1 text-sm md:text-base">Address</h4>
                      <p className="text-gray-600 text-sm md:text-base">123 Luxury Avenue, Beachfront District, Coastal City 90210</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <FiPhone className="text-yellow-600 text-lg md:text-xl mt-1 mr-3 md:mr-4" />
                    <div>
                      <h4 className="font-medium text-gray-800 mb-1 text-sm md:text-base">Phone</h4>
                      <p className="text-gray-600 text-sm md:text-base">+1 (555) 123-4567</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <FiMail className="text-yellow-600 text-lg md:text-xl mt-1 mr-3 md:mr-4" />
                    <div>
                      <h4 className="font-medium text-gray-800 mb-1 text-sm md:text-base">Email</h4>
                      <p className="text-gray-600 text-sm md:text-base">info@luxuryhaven.com</p>
                    </div>
                  </div>
                </div>
                
                <div className="mt-6 md:mt-8">
                  <h4 className="font-medium text-gray-800 mb-3 md:mb-4 text-sm md:text-base">Opening Hours</h4>
